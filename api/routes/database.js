...
module.exports = async (app) => {
	...
	app.delete('/api/database/delete', verifyTokenAndAdmin, DBController.deleteTable);
	app.get('/api/backup', DBController.getBackup);
	app.get('/api/backup/import_data', DBController.importData);
	app.post('/api/backup/add_backup_from_file', verifyTokenAndAdmin, DBController.addBackupFromFile);
	app.get('/api/backup/restore/:path', verifyTokenAndAdmin, DBController.restoreBackup);
